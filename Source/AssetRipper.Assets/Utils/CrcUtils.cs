...
namespace AssetRipper.Assets.Utils
{
	public static class CrcUtils
	{
		...
		public static string ReverseDigestAscii(uint digest)
		{
			uint b = digest ^ reverseInitialMask;
		...
		/// </summary>
		private static readonly uint reverseInitialMask = CalculateDigestAscii("HHHHHHH");
	}
}
